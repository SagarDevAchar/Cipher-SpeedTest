...
tee_print(f"\rARC4-40:\t{(end - start).total_seconds() / TRIALS:f} s\t{FS / T:f} MB/s")
...
T = (end - start).total_seconds() / TRIALS
tee_print(f"\rARC4-128:\t{(end - start).total_seconds() / TRIALS:f} s\t{FS / T:f} MB/s")
...
T = (end - start).total_seconds() / TRIALS
tee_print(f"\rARC4-192:\t{(end - start).total_seconds() / TRIALS:f} s\t{FS / T:f} MB/s")
...
T = (end - start).total_seconds() / TRIALS
tee_print(f"\rARC4-256:\t{(end - start).total_seconds() / TRIALS:f} s\t{FS / T:f} MB/s")
...
T = (end - start).total_seconds() / TRIALS
tee_print(f"\rARC4-2048:\t{(end - start).total_seconds() / TRIALS:f} s\t{FS / T:f} MB/s")
