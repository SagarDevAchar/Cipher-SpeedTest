...
tee_print(f"\rARC2-ECB-40:\t{(end - start).total_seconds() / TRIALS:f} s\t{FS / T:f} MB/s")
...
T = (end - start).total_seconds() / TRIALS
tee_print(f"\rARC2-ECB-128:\t{(end - start).total_seconds() / TRIALS:f} s\t{FS / T:f} MB/s")
...
T = (end - start).total_seconds() / TRIALS
tee_print(f"\rARC2-ECB-192:\t{(end - start).total_seconds() / TRIALS:f} s\t{FS / T:f} MB/s")
...
T = (end - start).total_seconds() / TRIALS
tee_print(f"\rARC2-ECB-256:\t{(end - start).total_seconds() / TRIALS:f} s\t{FS / T:f} MB/s")
...
T = (end - start).total_seconds() / TRIALS
tee_print(f"\rARC2-ECB-1024:\t{(end - start).total_seconds() / TRIALS:f} s\t{FS / T:f} MB/s")
