...
for _ in range(TRIALS):
    tee_print(f"\rARC2-ECB-40: {_}", end='')
...
start = dt.now()
for _ in range(TRIALS):
    tee_print(f"\rARC2-ECB-128: {_}", end='')
...
start = dt.now()
for _ in range(TRIALS):
    tee_print(f"\rARC2-ECB-192: {_}", end='')
...
start = dt.now()
for _ in range(TRIALS):
    tee_print(f"\rARC2-ECB-256: {_}", end='')
...
start = dt.now()
for _ in range(TRIALS):
    tee_print(f"\rARC2-ECB-1024: {_}", end='')
